...
namespace pe_bliss
{
	...
	public: //STUB
		...
		void strip_stub_overlay() noexcept;
		...
		const std::string& get_stub_overlay() const noexcept;
	...
	public: //PE HEADER
		//Returns DOS header
		const pe_win::image_dos_header& get_dos_header() const noexcept;
		pe_win::image_dos_header& get_dos_header() noexcept;

		//Returns PE header start (e_lfanew)
		int32_t get_pe_header_start() const noexcept;
