...
{
	//Default constructor
	message_table_item::message_table_item() noexcept
		:unicode_(false)
	{}
	...
	bool message_table_item::is_unicode() const noexcept
	{
		return unicode_;
	}

	//Returns ANSI string
	const std::string& message_table_item::get_ansi_string() const noexcept
	{
		return ansi_str_;
	}

	//Returns UNICODE string
	const std::wstring& message_table_item::get_unicode_string() const noexcept
	{
		return unicode_str_;
	}
